...
def simple_search(transactions: List[Dict[str, Any]], query: str) -> str:
    ...
    def pipeline(data):
        filtered = filter_transactions(data, contains_string(query))
        return map_transactions(filtered, format_transaction)

    results = pipeline(transactions)
...
def search_by_phone(transactions: List[Dict[str, Any]], phone_number: str = None) -> str:
    ...
    def pipeline(data):
        filtered = filter_transactions(data, predicate)
        return map_transactions(filtered, extract_phone_from_description)
...
def search_transfers_to_individuals(transactions: List[Dict[str, Any]]) -> str:
    ...
    def pipeline(data):
        filtered = filter_transactions(data, is_transfer_to_individual())
        return map_transactions(filtered, extract_recipient)
...
def search_by_category(transactions: List[Dict[str, Any]], category: str) -> str:
    ...
    def pipeline(data):
        filtered = filter_transactions(data, contains_category(category))
        return map_transactions(filtered, format_transaction)
